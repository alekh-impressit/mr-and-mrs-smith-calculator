...
/**
 * Class DivisionOperationController
 *
 * Process division operation
 *
 * @Route("/api/1.0/division", name="operation_division_1_0", methods={"POST"})
 */
class DivisionOperationController extends BaseController
{
    /**
